...
import { Menu, X, ChevronDown, Bell, Search, Settings } from "lucide-react";
            ...
            <div className="flex items-center">
              ...
              <a href="/" className="ml-2 flex items-center md:mr-24">
                <div className="mr-4 flex h-12 w-30 mt-3 items-center justify-center rounded-xl bg-linear-to-br shadow-lg transition-all duration-500">
                  <img src={Logo} className="text-lg font-bold text-white" />
                </div>
              ...
              <div className="relative">
                ...
                >
                  <div className="flex h-10 w-10 items-center justify-center rounded-full bg-linear-to-br from-blue-400 to-purple-500 text-sm font-semibold text-white shadow-lg">
                    {user?.role === "Professor" && user?.gender === "Male" ? (
                            <img src={Male} alt="Professor Male" />
                          ) : user?.role === "Professor" && user?.gender === "Female" ? (
                            <img src={Female} alt="Professor Female" />
                          ) : user?.role === "Student" && user?.gender === "Male" ? (
                            <img src={StudentMale} alt="Student Male" />
                          ) : user?.role === "Student" && user?.gender === "Female" ? (
                            <img src={StudentFemale} alt="Student Female" />
                          ) : (
                            <img src={Male} alt="Default" />
                          )}
                  </div>
