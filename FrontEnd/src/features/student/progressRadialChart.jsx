...
const ProgressRadialChart = ({ completed, total, percentage }) => {
  // الداتا لي كتحتاجها Recharts
  // كنصاوبو Array فيها كاع الـ 100% ولكن كنعطيوها الـ value ديال التلميذ
  const data = [
    {
      name: 'Progress',
      value: percentage || 0,
      fill: '#8b5cf6', // لون الـ Purple اللي خدامين بيه
    },
  ];
      ...
      <div className="h-64 w-full relative">
        <ResponsiveContainer width="100%" height="100%">
          <RadialBarChart 
            ...
            endAngle={450}
          >
            {/* هاد المحور هو لي كيخلي الدائرة تكمل لـ 100 */}
            <PolarAngleAxis
              type="number"
              domain={[0, 100]}
              angleAxisId={0}
            ...
            <RadialBar
              minAngle={15}
              background={{ fill: '#f3f4f6' }} // لون الخلفية (الرمادي البارد)
              clockWise
              dataKey="value"
              cornerRadius={10}
            />
